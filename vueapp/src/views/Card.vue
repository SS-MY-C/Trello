    ...
    <div class="popup">
      <div class="popup-header">
        <div class="popup-title">
          ...
          <div class="popup-title-text">
            <textarea class="form-field-input" @blur="editCardName">{{
              card.name
            }}</textarea>
          </div>
      ...
      <div class="popup-content">
        ...
        <div class="window-module">
          ...
          <p class="description">
            <textarea class="form-field-input" @blur="editCardDescription">{{
              card.description
            }}</textarea>
          </p>
        </div>
