...
import {PostAddListBody,GetListsQuery,PutUpdateListBody,getBoardList} from '../validators/BoardList'
import {getAndValidatorBoard} from '../validators/Board'
...
export class BoardListController {
    ...
    public async addList(
        ...
        await getAndValidatorBoard(boardId , ctx.userInfo.id);
    ...
    public async getList(
        ...
        let boardList = await getBoardList(id,ctx.userInfo.id)
        return boardList
    }
