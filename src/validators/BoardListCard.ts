...
export class PostAddCardBody{
    ...
    @Min(1,{
        message:'boardListId不能为空且必须大于1的'
    })
    boardListId:number;
...
export async function getBoardListCard(id:number , userId:number):Promise<BoardListCardModel>{
...
export async function getBoardListCardAttachment(id:number , userId:number):Promise<CardAttachmentModel>{
